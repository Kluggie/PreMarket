...
export const PLAN_FEATURES = {
  starter: [
    ...
    { text: 'Basic Step 2 suggestion tools',            detail: 'Drafting assistance with Starter usage limits' },
    ...
    { text: 'Upgrade for additional review capacity',   detail: 'Move to Professional when you need more monthly reviews' },
  ],
  professional: [
    ...
    { text: 'Expanded Step 2 suggestion capacity', detail: 'Higher monthly drafting and refinement assistance capacity' },
  ...
  enterprise: [
    ...
    { text: 'Advanced privacy and security review',    detail: 'Security and privacy review scoped during sales' },
    { text: 'Custom onboarding and workflow setup',    detail: 'Tailored setup for your process and teams' },
    { text: 'Admin controls and usage oversight',      detail: 'Account-level usage visibility and administration' },
    { text: 'Advanced reporting and data analytics',   detail: 'Deeper reporting and workflow insights' },
    { text: 'Priority support and response targets',   detail: 'Support expectations defined with the account' },
