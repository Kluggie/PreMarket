          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                Review each field and mark it as Confirmed (accurate), Disputed (incorrect), or Unknown (cannot verify).
                Your verification helps build trust and improves the accuracy of AI evaluations.
              </p>
            </div>
          </div>
        </CardContent>
                  ...
                  {currentStatus && (
                    <div className="mt-3">
                      ...
                      <Textarea
                        ...
                        onChange={(e) => setNotes(prev => ({ ...prev, [response.id]: e.target.value }))}
