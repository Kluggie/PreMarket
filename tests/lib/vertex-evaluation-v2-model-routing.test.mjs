...
function evalPayload(overrides = {}) {
  return JSON.stringify({
    ...
    confidence_0_1: 0.71,
    why: [
      'Executive Summary: Scope aligns with internal requirements.',
      'Key Strengths: Timeline is achievable given existing resources.',
      'Key Risks: Auto-renewal clause needs explicit opt-out provision.',
      'Decision Readiness: Near-ready pending renewal clarification.',
      'Recommendations: Add renewal opt-out language before signing.',
    ],
    missing: ['Confirm budget ceiling is within approved range.'],
    redactions: [],
    ...overrides,
  });
}
