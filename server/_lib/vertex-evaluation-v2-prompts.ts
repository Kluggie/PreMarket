...
export function buildStage1SharedIntakePromptFromFactSheet(params: {
  ...
  return [
    ...
    '- other_side_needed must stay neutral. Prefer concise collaborative fragments, not directive requests or a deliverables checklist. These items should also combine cleanly into compact prose.',
    '- discussion_starting_points must be practical prompts for the next exchange, not conclusions or decisions, and they should stay short enough to read smoothly as compact prose.',
