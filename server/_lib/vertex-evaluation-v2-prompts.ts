...
export function buildEvalPromptFromFactSheet(params: {
  ...
  return [
    ...
    '- CRITICAL ANTI-REPETITION RULE: Each substantive point (blocker, alignment point, bridge, open question) may appear ONCE in the entire output. Do NOT restate the same idea in Mediation Summary, then again in another section, then again in Decision Readiness. State it clearly once; reference it briefly elsewhere if needed.',
    ...
    '',
    '- Narrative mediation note (good default): 3-4 well-formed paragraphs in Mediation Summary. Open with alignment, surface the real sticking point, assess bridgeability, propose path forward. Most cases should use this.',
    ...
    '  Write 3-4 paragraphs: open with shared alignment, identify the real sticking point in plain English, explain whether the matter is bridgeable, and suggest the most realistic path forward.',
    '  This section alone should give both parties a clear picture of where things stand and how to move forward.',
    ...
    '  Keep Decision Readiness concise (1-2 paragraphs). Do NOT repeat blockers already covered in the Mediation Summary.',
    ...
    '- Vary confidence genuinely based on the case. Materially different situations must produce materially different confidence values:',
    '  0.80-0.92: high-fit, well-bounded scope, all major terms clear, minor cleanup only.',
    '  0.65-0.79: broadly viable but has 1-2 meaningful open items or risk gaps.',
    '  0.50-0.64: conditionally viable but several material unknowns or structural risks remain.',
    '  0.35-0.49: substantial uncertainty, missing critical information, or structural weakness.',
    '  0.15-0.34: not viable on current record or too little information to assess.',
    '- Do NOT default to a single confidence value for all conditional cases. Use the full range above.',
